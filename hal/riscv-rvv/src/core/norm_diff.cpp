...
struct NormDiffL1_RVV<float, double> {
    double operator() (const float* src1, const float* src2, int n) const {
        ...
        auto s0 = __riscv_vfmv_v_f_f64m4(0, vlmax);
        auto s1 = __riscv_vfmv_v_f_f64m4(0, vlmax);
        auto one = __riscv_vfmv_v_f_f32m2(1, vlmax);
        int i = 0;
        for (; n - i >= 2 * vlmax; i += 2 * vlmax) {
            auto v10 = __riscv_vle32_v_f32m2(src1 + i, vlmax);
            auto v20 = __riscv_vle32_v_f32m2(src2 + i, vlmax);
            auto v0 = __riscv_vfabs(__riscv_vfsub(v10, v20, vlmax), vlmax);
            s0 = __riscv_vfwmacc_vv_f64m4_tu(s0, one, v0, vlmax);
            auto v11 = __riscv_vle32_v_f32m2(src1 + i + vlmax, vlmax);
            auto v21 = __riscv_vle32_v_f32m2(src2 + i + vlmax, vlmax);
            auto v1 = __riscv_vfabs(__riscv_vfsub(v11, v21, vlmax), vlmax);
            s1 = __riscv_vfwmacc_vv_f64m4_tu(s1, one, v1, vlmax);
        }
        int vl;
        for (; i < n; i += vl) {
            vl = __riscv_vsetvl_e32m2(n - i);
            auto v1 = __riscv_vle32_v_f32m2(src1 + i, vl);
            auto v2 = __riscv_vle32_v_f32m2(src2 + i, vl);
            auto v = __riscv_vfabs(__riscv_vfsub(v1, v2, vl), vl);
            s0 = __riscv_vfwmacc_vv_f64m4_tu(s0, one, v, vl);
        }
        s0 = __riscv_vfadd(s0, s1, vlmax);
        return __riscv_vfmv_f(__riscv_vfredosum(s0, __riscv_vfmv_s_f_f64m1(0, vlmax), vlmax));
    }
};
...
struct NormDiffL2_RVV<float, double> {
    double operator() (const float* src1, const float* src2, int n) const {
        ...
        for (; n - i >= 2 * vlmax; i += 2 * vlmax) {
            auto v10 = __riscv_vle32_v_f32m2(src1 + i, vlmax);
            auto v20 = __riscv_vle32_v_f32m2(src2 + i, vlmax);
            auto v0 = __riscv_vfsub(v10, v20, vlmax);
            s0 = __riscv_vfwmacc_vv_f64m4_tu(s0, v0, v0, vlmax);
            auto v11 = __riscv_vle32_v_f32m2(src1 + i + vlmax, vlmax);
            auto v21 = __riscv_vle32_v_f32m2(src2 + i + vlmax, vlmax);
            auto v1 = __riscv_vfsub(v11, v21, vlmax);
            s1 = __riscv_vfwmacc_vv_f64m4_tu(s1, v1, v1, vlmax);
        }
        int vl;
        for (; i < n; i += vl) {
            vl = __riscv_vsetvl_e32m2(n - i);
            ...
            s0 = __riscv_vfwmacc_vv_f64m4_tu(s0, v, v, vl);
        }
        s0 = __riscv_vfadd(s0, s1, vlmax);
        return __riscv_vfmv_f(__riscv_vfredosum(s0, __riscv_vfmv_s_f_f64m1(0, vlmax), vlmax));
    }
...
struct MaskedNormDiffInf_RVV<schar, int> {
    int operator() (const schar* src1, const schar* src2, const uchar* mask, int len, int cn) const {
        if (cn == 1) {
            ...
            auto s = __riscv_vmv_v_x_u8m4(0, vlmax);
            int vl;
            for (int i = 0; i < len; i += vl) {
...
struct MaskedNormDiffInf_RVV<ushort, int> {
    int operator() (const ushort* src1, const ushort* src2, const uchar* mask, int len, int cn) const {
        if (cn == 1) {
            ...
            auto s = __riscv_vmv_v_x_u16m4(0, vlmax);
            int vl;
            for (int i = 0; i < len; i += vl) {
                vl = __riscv_vsetvl_e16m4(len - i);
                auto v1 = __riscv_vle16_v_u16m4(src1 + i, vl);
                auto v2 = __riscv_vle16_v_u16m4(src2 + i, vl);
                auto v = __riscv_vsub(__riscv_vmaxu(v1, v2, vl), __riscv_vminu(v1, v2, vl), vl);
                auto m = __riscv_vle8_v_u8m2(mask + i, vl);
                auto b = __riscv_vmsne(m, 0, vl);
                s = __riscv_vmaxu_tumu(b, s, s, v, vl);
            }
...
struct MaskedNormDiffInf_RVV<short, int> {
    int operator() (const short* src1, const short* src2, const uchar* mask, int len, int cn) const {
        if (cn == 1) {
            ...
            for (int i = 0; i < len; i += vl) {
                vl = __riscv_vsetvl_e16m4(len - i);
                auto v1 = __riscv_vle16_v_i16m4(src1 + i, vl);
                auto v2 = __riscv_vle16_v_i16m4(src2 + i, vl);
                auto v = __riscv_vreinterpret_u16m4(__riscv_vsub(__riscv_vmax(v1, v2, vl), __riscv_vmin(v1, v2, vl), vl));
                auto m = __riscv_vle8_v_u8m2(mask + i, vl);
                auto b = __riscv_vmsne(m, 0, vl);
                s = __riscv_vmaxu_tumu(b, s, s, v, vl);
            }
...
struct MaskedNormDiffInf_RVV<int, int> {
    int operator() (const int* src1, const int* src2, const uchar* mask, int len, int cn) const {
        if (cn == 1) {
            int vlmax = __riscv_vsetvlmax_e32m4();
            auto s = __riscv_vmv_v_x_u32m4(0, vlmax);
            int vl;
            for (int i = 0; i < len; i += vl) {
                vl = __riscv_vsetvl_e32m4(len - i);
                auto v1 = __riscv_vle32_v_i32m4(src1 + i, vl);
                auto v2 = __riscv_vle32_v_i32m4(src2 + i, vl);
                auto v = common::__riscv_vabs(__riscv_vsub(v1, v2, vl), vl);
    ...
    double operator() (const float* src1, const float* src2, const uchar* mask, int len, int cn) const {
        if (cn == 1) {
            ...
            for (; len - i >= 2 * vlmax; i += 2 * vlmax) {
                ...
                auto v20 = __riscv_vle32_v_f32m2(src2 + i, vlmax);
                auto v0 = __riscv_vfabs(__riscv_vfsub(v10, v20, vlmax), vlmax);
                auto m0 = __riscv_vle8_v_u8mf2(mask + i, vlmax);
                auto b0 = __riscv_vmsne_vx_u8mf2_b16(m0, 0, vlmax);
                s0 = __riscv_vfwmacc_vv_f64m4_tumu(b0, s0, one, v0, vlmax);
                auto v11 = __riscv_vle32_v_f32m2(src1 + i + vlmax, vlmax);
                auto v21 = __riscv_vle32_v_f32m2(src2 + i + vlmax, vlmax);
                auto v1 = __riscv_vfabs(__riscv_vfsub(v11, v21, vlmax), vlmax);
                auto m1 = __riscv_vle8_v_u8mf2(mask + i + vlmax, vlmax);
                auto b1 = __riscv_vmsne_vx_u8mf2_b16(m1, 0, vlmax);
                s1 = __riscv_vfwmacc_vv_f64m4_tumu(b1, s1, one, v1, vlmax);
            }
            int vl;
            for (; i < len; i += vl) {
                ...
                auto b = __riscv_vmsne_vx_u8mf2_b16(m, 0, vl);
                s0 = __riscv_vfwmacc_vv_f64m4_tumu(b, s0, one, v, vl);
            }
            s0 = __riscv_vfadd(s0, s1, vlmax);
            return __riscv_vfmv_f(__riscv_vfredosum(s0, __riscv_vfmv_s_f_f64m1(0, vlmax), vlmax));
        }
    ...
    double operator() (const float* src1, const float* src2, const uchar* mask, int len, int cn) const {
        if (cn == 1) {
            ...
            for (; len - i >= 2 * vlmax; i += 2 * vlmax) {
                ...
                auto m0 = __riscv_vle8_v_u8mf2(mask + i, vlmax);
                auto b0 = __riscv_vmsne_vx_u8mf2_b16(m0, 0, vlmax);
                s0 = __riscv_vfwmacc_vv_f64m4_tumu(b0, s0, v0, v0, vlmax);
                auto v11 = __riscv_vle32_v_f32m2(src1 + i + vlmax, vlmax);
                auto v21 = __riscv_vle32_v_f32m2(src2 + i + vlmax, vlmax);
                auto v1 = __riscv_vfsub(v11, v21, vlmax);
                auto m1 = __riscv_vle8_v_u8mf2(mask + i + vlmax, vlmax);
                auto b1 = __riscv_vmsne_vx_u8mf2_b16(m1, 0, vlmax);
                s1 = __riscv_vfwmacc_vv_f64m4_tumu(b1, s1, v1, v1, vlmax);
            }
            int vl;
            for (; i < len; i += vl) {
                vl = __riscv_vsetvl_e32m2(len - i);
                ...
                auto m = __riscv_vle8_v_u8mf2(mask + i, vl);
                auto b = __riscv_vmsne_vx_u8mf2_b16(m, 0, vl);
                s0 = __riscv_vfwmacc_vv_f64m4_tumu(b, s0, v, v, vl);
            }
            s0 = __riscv_vfadd(s0, s1, vlmax);
            return __riscv_vfmv_f(__riscv_vfredosum(s0, __riscv_vfmv_s_f_f64m1(0, vlmax), vlmax));
        }
